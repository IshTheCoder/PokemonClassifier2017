...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
##X_train, X_test, y_train, y_test = train_test_split(image_stack, categorical_labels, test_size=0.33, random_state=seed)


model.fit(image_stack,categorical_labels,validation_split=0.2,batch_size=601,nb_epoch=5,shuffle=True,)
pred_test = model.predict(image_stack_test)
print pred_test

model.save_weights("./models/model_0val.hdf5")

model.load_weights("./models/model_0val.hdf5")
