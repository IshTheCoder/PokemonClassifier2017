...
model = Sequential([
        Convolution2D(32, 5, 5, input_shape=(96,96,3), dim_ordering="tf"),
        Activation("relu"),
        MaxPooling2D((2,2)),
...
np.savetxt("final_withavg_conv_neu_flow_removed_less_layers.csv", next_array, delimiter=",",fmt='%i',header='number,type')
